...
// bundle. It also implements UP-003: re-running Up against a host it has
// already deployed to is safe and converges that host to the bundle
// definition, rather than requiring a fresh host every time.
//
